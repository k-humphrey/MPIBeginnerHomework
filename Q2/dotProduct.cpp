...
int main(int argc, char **argv){
    ...
    //two vectors of size SIZE initialized to be all twos.
    ...
    /*I actually tried to do this myself, I noticed that when you divide rank by stride, if that answer is an even or
    odd number decides whether the current rank is a sender or a reciever.
    I also noticed that all elements are done after they send once, so we can make them go away.
    Big inspiration came from the link at the top of dotP.md*/
    ...
    if(myRank == 0){
        ...
        cout << "This took process with rank 0, " << end_time - start_time << " seconds";
    }
